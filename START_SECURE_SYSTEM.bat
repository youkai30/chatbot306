...
echo.
echo 🚀 تشغيل النظام الآمن الموحد...
echo.

REM تشغيل الباك-إند الآمن الموحد (API + واجهة أمامية)
echo 🔐 تشغيل الباك-إند الآمن الموحد...
...
echo.
echo 📋 النظام الآمن الموحد يعمل على (يفترض المنفذ 8001 أو كما في .env):
echo    🔐 الباك-إند و الواجهة: http://localhost:8001
echo    🏠 الصفحة الرئيسية: http://localhost:8001/
echo    💬 الشات بوت الآمن: http://localhost:8001/web-integration/chatbot-widget.html
echo    📊 لوحة التحكم: http://localhost:8001/dashboard/index.html
echo    🔧 لوحة AI: http://localhost:8001/dashboard/ai_dashboard.html
echo.
...
if errorlevel 1 (
    ...
    echo ✅ الباك-إند الآمن الموحد يستجيب بنجاح.
)
